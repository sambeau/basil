...
- **Minimal index.pars**: Just `<h1>🌿 Hello from Basil 👋</h1>` - easy to understand and modify
...
### Affected Components
- `cmd/basil/main.go` — Add `--init` flag parsing and command handler
- `cmd/basil/init.go` (new) — Implementation of init command logic
