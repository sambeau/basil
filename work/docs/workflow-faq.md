...
Questions about the Basil development workflow process. AI adds new entries when answering "how do I..." questions about process, specs, plans, or git workflow.
...
- **Specs** (`work/specs/`): What we're building and why. Written mostly by human.
- **Plans** (`work/plans/`): How we're building it, step by step. Written mostly by AI.
...
Conventional Commits. See `.github/instructions/commits.instructions.md` or the [Workflow Cheatsheet](workflow-cheatsheet.md).
...
<!-- AI: Add new workflow Q&A entries above this line, with *Added: YYYY-MM-DD* -->
