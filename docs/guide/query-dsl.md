...
**Error handling:** If any operation fails, the entire transaction is rolled back and an error is returned. On success, the last expression in the block is returned.
